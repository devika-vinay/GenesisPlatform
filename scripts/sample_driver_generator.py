...
OUTPUT_FILE = os.path.join(BASE_DIR, "data", "processed", "sample_drivers.csv")
...
# Save to CSV
df_drivers.to_csv(OUTPUT_FILE, index=False)
print(f"✅ Driver dataset with {TOTAL_DRIVERS} drivers saved to {OUTPUT_FILE} using seed {RANDOM_SEED}")
